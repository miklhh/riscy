...
add wave -noupdate /rv32ui_p_tb/DUT/riscy_core/PC(0)
add wave -noupdate /rv32ui_p_tb/DUT/riscy_core/stall(0)
add wave -noupdate /rv32ui_p_tb/DUT/riscy_core/stall
add wave -noupdate /rv32ui_p_tb/DUT/riscy_core/PC_mux
add wave -noupdate -subitemconfig {/rv32ui_p_tb/DUT/riscy_core/IR_debug(0) -expand} /rv32ui_p_tb/DUT/riscy_core/IR_debug
...
update
WaveRestoreZoom {0 ps} {379365 ps}
